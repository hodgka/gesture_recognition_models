...
def get_transforms(train_crop='corner', sample_size=84, init_scale=1.0, n_scales=5, mean=[0., 0., 0.], std=[1., 1., 1.], time_window=16):
    scales = [init_scale]
    ...
    if train_crop == 'random':
        ...
        crop_method = MultiScaleCornerCrop(scales, sample_size, crop_positions=['c'])
    spatial_transform = Compose([
        crop_method,
        RandomHorizontalFlip(),
        ToTensor(1), norm_method
    ])
    temporal_transform = TemporalRandomCrop(time_window)
